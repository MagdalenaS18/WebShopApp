...
namespace UserWebApi.Services.Implementations
{
    public class UserService:IUserService
    {
        ...
        public async Task<ResponsePackage<bool>> RegisterUser(UserDTO userDTO, SD.Roles Role, string file)
        {
            ...
            //    emailContent = $"<p>Zdravo {newUser.FirstName} {newUser.LastName},</p>";
            //    emailContent += $"<p>Molimo vas da sačekate da neko od naših administratora odobri vaš profil.</p>";
            //}
        ...
        public ResponsePackage<ProfileDTO> GetProfile(long id)
        {
